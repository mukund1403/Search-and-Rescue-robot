...
#define LF                 10 //6   // Left forward pin
#define LR                 11 //5   // Left reverse pin
#define RF                 6 //10  // Right forward pin
#define RR                 5 //11  // Right reverse pin

//PI for calculating turning circumference
//Not needed to define 
...
//Variables to keep track of whether we have moved a certain distance
...
/*
 * Alex's setup and run codesSerial.print("RIGHTFORWARD: ");
  Serial.println(rightForwardTicks);
 * 
 */
